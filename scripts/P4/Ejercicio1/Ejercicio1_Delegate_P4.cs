...
* Fecha: 18/10/23
* Script que sirve para crear un evento que permite que las esferas del grupo 1 cambien de color y las del grupo 2 
...
public class Ejercicio1_Delegate_P4 : MonoBehaviour
{
